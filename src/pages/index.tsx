    ...
    <>
      {
        !isAuthenticated ? <Login isAuthenticated={isAuthenticated} setIsAuthenticated={authenticationHandler} /> : (
          <main
            className={`flex flex-row bg-[#EAD196] min-h-screen ${inter.className}`}
          >
            <div className='w-1/4'>
            ...
            {
              showMessageState ? (
                <ReceivedMessages userData={userData} />
              ) : (
                <>

                  <div className='w-3/4 justify-center align-center items-center min-h-screen items-center'>
                    {
